...
def get_params():
    ...
    parser.add_argument('--out', '-o', type=str, default='./data/CrawlE_Proc_files.txt')
...
if __name__ == '__main__':
    ...
    threshold = args.threshold # min number of packets per window in both ends, used  30 for 500

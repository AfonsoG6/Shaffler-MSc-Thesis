...
def get_params():
    ...
    parser.add_argument ('--input', required=False, default='./datasets/new_dcf_data/crawle_new_overlap_interval')
    parser.add_argument ('--test', required=False, default='./data/DeepCCA_model/crawle_overlap_new2021_interal')
    parser.add_argument ('--model', required=False, default="./data/DeepCCA_model/crawle_overlap_new2021_")

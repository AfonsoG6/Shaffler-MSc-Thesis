...
def get_params():
    ...
    parser.add_argument('--data', '-d', type=str, default='./datasets/CrawlE_Proc/')
    parser.add_argument('--list', '-l', type=str, default='./data/CrawlE_Proc_files.txt')
    parser.add_argument('--prefix', '-p', type=str, default='./datasets/new_dcf_data/crawle_new_overlap_interval')
